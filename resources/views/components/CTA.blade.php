<div style="background-image: url('{{asset('/storage/media/banners/gettyimages-5.jpg')}}') ;   background-repeat: no-repeat;
  background-size: cover; " class="p-6 pt-8 max-w-xl  h-[24rem] rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
    <a href="#">
