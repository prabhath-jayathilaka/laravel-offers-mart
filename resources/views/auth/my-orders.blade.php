<x-app-layout>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    ...
                                                    @if($order->status === 'PROCESSING')
                                                        <span
                                                            class="px-2 inline-flex text-xs leading-5 font-semi-bold rounded-full bg-blue-200 text-blue-600"> {{$order->status}} </span>

                                                    @elseif($order->status === 'DELIVERED')
                                                        <span
                                                            class="px-2 inline-flex text-xs leading-5 font-semi-bold rounded-full bg-green-200 text-green-600"> {{$order->status}} </span>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{$order->deliver_date}}
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex  ">
                                                    ...
                                                    <button type="button" data-modal-toggle="make-review-model"
                                                            class="mx-1 px-1.5 py-1 text-xs  text-gray-600 rounded uppercase tracking-wider font-semi-bold bg-slate-300 hover:bg-slate-600 hover:text-white  ">
                                                        Review
                                                    </button>
                                                    <button type="button" data-modal-toggle="return-model"
                                                            class="mx-1 px-1.5 py-1 text-xs  text-gray-600 rounded uppercase tracking-wider font-semi-bold bg-slate-300 hover:bg-slate-600 hover:text-white  ">
                                                        Return
                                                    </button>
    ...
    <!-- make--review-model  -->
    <div id="make-review-model" aria-hidden="true"
         class=" bg-gray-200 bg-opacity-75 hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
        <div class="relative w-full max-w-4xl px-4 h-full md:h-auto ">
            <!-- Modal content -->
            <div class="bg-white rounded-lg shadow relative border-2 border-gray-300 ">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="make-review-model">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                  clip-rule="evenodd"></path>
                ...
                <div class="flex space-x-2 items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-toggle="make-review-model" type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Close
                    </button>
    ...
    <!-- end make--review-model  -->

    <!-- *************************************************************************** -->

    <!-- return-model  -->
    <div id="return-model" aria-hidden="true"
         class=" bg-gray-200 bg-opacity-75 hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
        <div class="relative w-full max-w-4xl px-4 h-full md:h-auto ">
            <!-- Modal content -->
            <div class="bg-white rounded-lg shadow relative border-2 border-gray-300 ">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="return-model">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                  clip-rule="evenodd"></path>
                ...
                <!-- Modal footer -->
                <div class="flex space-x-2 items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-toggle="return-model" type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Close
                    </button>
                </div>
